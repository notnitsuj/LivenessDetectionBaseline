...
test2_paths = glob.glob('data/public_test_2/videos/*')
os.makedirs('data/public_test_2/images', exist_ok=True)
...
for test_path in tqdm(test2_paths):
    vidcap = cv2.VideoCapture(test_path)
    length = int(vidcap.get(cv2.CAP_PROP_FRAME_COUNT))
    ...
    if length > 11:
        ...
        for frame_id in frames:
            ...
            cv2.imwrite('data/public_test_2/images/{}_{}.png'.format(vidname, frame_id), image)